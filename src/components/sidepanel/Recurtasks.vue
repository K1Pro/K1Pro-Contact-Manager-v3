      ...
      <template v-for="(recurTask, recurTaskIndex) in recurtasks">
        ...
        >
          <i
            ...
            @click="deleteContactInfo('RecurTasks', recurTask.RealIndex)"
          ></i>
          ...
          ><input
            ...
            :value="recurTask.End"
            @change="
              updateRecurTask($event.target.value, recurTask.RealIndex, 'End')
            "
            :class="[recurTaskIndex % 2 ? 'even-task' : 'odd-task']"
          />
          ...
          ><input
            ...
            @change="
              updateRecurTask($event.target.value, recurTask.RealIndex, 'Time')
            "
            :class="[recurTaskIndex % 2 ? 'even-task' : 'odd-task']"
          />
          ...
          <button
            @click="
              updateRecurTask(
                times.Y_m_d_H_i_s_z.slice(0, 10),
                recurTask.RealIndex,
                'Review'
              )
            "
